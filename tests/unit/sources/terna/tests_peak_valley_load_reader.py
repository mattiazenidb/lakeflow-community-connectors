...
def test_terna_full_missing_date_from():
    ...
    with pytest.raises(ValueError, match="peak_valley_load requires 'date_from'"):
        records_iter, offset = connector.read_table("peak_valley_load", start_offset, table_options)
...
def test_terna_full_start_end_dates():
    ...
    connector = TernaLakeflowConnect(config)
    table_options = {"date_from": "01/02/2024", "date_to": "29/02/2024"}
